...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("multi_tensor_quantize_into", &transformer_engine::pytorch::multi_tensor_quantize_into,
        "Multi-tensor quantize into existing outputs", py::arg("tensor_list"),
        py::arg("quantizer_list"), py::arg("output_list"), py::arg("noop_flag") = py::none());
  ...
  m.def("fused_multi_row_padding_pair",
        &transformer_engine::pytorch::fused_multi_row_padding_pair,
        "Fused mixed-dtype paired multi-tensor padding", py::call_guard<py::gil_scoped_release>());
  ...
  m.def("fused_multi_row_unpadding_pair",
        &transformer_engine::pytorch::fused_multi_row_unpadding_pair,
        "Fused mixed-dtype paired multi-tensor unpadding",
        py::call_guard<py::gil_scoped_release>());
